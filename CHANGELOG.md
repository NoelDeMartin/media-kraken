...
- [#46](https://github.com/NoelDeMartin/media-kraken/issues/46) Trim login input url (thanks to [Tobias Kausch](https://github.com/tobika)!).

## [v0.1.26](https://github.com/NoelDeMartin/media-kraken/releases/tag/v0.1.26) - 2025-12-14

### Changed

- [Christmas attire](https://github.com/NoelDeMartin/media-kraken/tree/v0.1.26/src/assets/icons/media-kraken.svg).

## [v0.1.25](https://github.com/NoelDeMartin/media-kraken/releases/tag/v0.1.25) - 2025-11-06

### Changed

- 🎃 Removed Halloween costumes + recommendations.

## [v0.1.24](https://github.com/NoelDeMartin/media-kraken/releases/tag/v0.1.24) - 2025-10-01

### Fixed

- Halloween recommendation for Little Shop of Horrors was the wrong version.

## [v0.1.23](https://github.com/NoelDeMartin/media-kraken/releases/tag/v0.1.23) - 2025-10-01

### Changed

- 🎃 Halloween costumes + recommendations.

### Fixed

- [#43](https://github.com/NoelDeMartin/media-kraken/issues/43) Fix viewer for movies without timestamps.
- [#41](https://github.com/NoelDeMartin/media-kraken/issues/41) Use links instead of strings for movie images.

## [v0.1.22](https://github.com/NoelDeMartin/media-kraken/releases/tag/v0.1.22) - 2025-04-22

### Fixed

- [#39](https://github.com/NoelDeMartin/media-kraken/issues/39) Fixed get-a-pod link.

## [v0.1.21](https://github.com/NoelDeMartin/media-kraken/releases/tag/v0.1.21) - 2025-01-05
...
- Collection filters in query parameters.
...
- [#28](https://github.com/NoelDeMartin/media-kraken/issues/28) Import from Netflix (TV Shows were not ignored).
